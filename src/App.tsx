...
const YOUTUBE_SUBCATEGORIES = ['All', 'Vlog', 'Podcast', 'Talking Head'];
...
const DEFAULT_VIDEOS = [
  ...
  {
    id: 2,
    title: 'The Business Podcast Ep.1',
    category: 'YouTube / Long Format',
    subcategory: 'Podcast',
    youtubeId: 'ScMzIvxBSi4',
    description: 'Full podcast episode',
  },
  {
    id: 3,
    ...
    description: 'Talking head series',
  },
  {
    id: 4,
    title: '60-Second Hook Reel',
    category: 'Short Form',
    subcategory: null,
  ...
  },
  {
    ...
    description: 'Full event highlight reel',
  },
  {
    id: 6,
    ...
    description: 'Executive brand content',
  },
  {
    id: 7,
    title: 'The Grind Documentary',
    category: 'Documentaries',
    subcategory: null,
    youtubeId: 'kJQP7kiw5Fk',
    description: 'Feature-length doc',
  },
  {
    id: 8,
...
export default function JFlowpix() {
  ...
  // Secret keyboard shortcut: type "admin" to open admin panel
  useEffect(() => {
    function onKey(e) {
  ...
  const subcatCount = (sub) =>
    sub === 'All'
      ? videos.filter((v) => v.category === 'YouTube / Long Format').length
      : videos.filter(
          (v) => v.category === 'YouTube / Long Format' && v.subcategory === sub
        ).length;
    ...
    >
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .nav-instagram svg { opacity: 0.5; transition: opacity 0.2s; }
        ...
        .hero-bg {
          ...
          background: radial-gradient(ellipse at 85% 10%, rgba(204,0,0,0.14) 0%, transparent 55%),
                      radial-gradient(ellipse at 0% 100%, rgba(204,0,0,0.07) 0%, transparent 45%);
        }
        .hero-tag {
          display: inline-flex; align-items: center; gap: 8px;
          font-size: 10px; letter-spacing: 4px; text-transform: uppercase;
          color: #CC0000; margin-bottom: 28px;
        }
        ...
        .hero-desc {
          ...
          max-width: 400px; line-height: 1.7; letter-spacing: 0.3px;
        }
        .hero-stats {
        ...
        .filters {
          padding: 0 48px; border-bottom: 1px solid rgba(255,255,255,0.06);
          display: flex; overflow-x: auto; scrollbar-width: none;
        }
        .filters::-webkit-scrollbar { display: none; }
        .filter-tab {
          padding: 20px 22px; font-size: 11px; letter-spacing: 2px; text-transform: uppercase;
        ...
        .subcat-bar {
          padding: 0 48px; background: rgba(204,0,0,0.03);
        ...
        .subcat-btn {
          padding: 14px 18px; font-size: 10px; letter-spacing: 2px; text-transform: uppercase;
          color: #444; cursor: pointer; border: none; background: none;
        ...
        .card-overlay {
          ...
          background: linear-gradient(to top, rgba(0,0,0,0.9) 0%, rgba(204,0,0,0.3) 100%);
          display: flex; flex-direction: column; justify-content: flex-end; padding: 20px;
        }
        .overlay-play {
          position: absolute; top: 50%; left: 50%; transform: translate(-50%,-60%);
          width: 56px; height: 56px; border: 2px solid rgba(255,255,255,0.8); border-radius: 50%;
        ...
        .load-more-btn {
          padding: 16px 48px; border: 1px solid rgba(255,255,255,0.08);
          background: transparent; color: #666; font-size: 11px; letter-spacing: 3px;
        ...
        .empty-state { text-align: center; padding: 100px 24px; color: #333; }
        .empty-state p { font-size: 13px; margin-top: 12px; color: #444; }

        .modal-overlay {
          position: fixed; inset: 0; z-index: 999; background: rgba(0,0,0,0.96);
        ...
        @media(max-width: 768px) {
          ...
          .video-grid { grid-template-columns: repeat(auto-fill, minmax(240px, 1fr)); gap: 2px; }
      ...
      <nav className="nav">
        <div className="nav-logo">
          J<span>Flow</span>pix
        </div>
        <a
          className="nav-instagram"
          href="https://instagram.com/jflowpix"
          target="_blank"
          rel="noreferrer"
        >
          <svg
      ...
      <section className="hero">
        ...
        <h1 className="hero-title">
          <span className="dim">J</span>Flow<span className="red">pix</span>
        </h1>
        <p className="hero-desc">
          Visual stories that stop the scroll. Long format, short form, events,
                ...
                <div className="thumb-wrap">
                  ...
                  <div className="card-overlay">
                    ...
                    <div className="overlay-info">
                      {video.subcategory && (
                        <p className="overlay-subcat">{video.subcategory}</p>
                      )}
        ...
        <div className="modal-overlay" onClick={() => setModalVideo(null)}>
          <div className="modal-box" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-meta">
              ...
              {modalVideo.subcategory && (
                <span className="modal-subcat">{modalVideo.subcategory}</span>
              )}
      ...
      {/* ADMIN PANEL — hidden, triggered by typing "admin" on keyboard */}
      {showAdmin && (
          ...
          <div className="admin-panel" onClick={(e) => e.stopPropagation()}>
            ...
            {!adminAuthed ? (
              <>
                ...
                <button className="btn-red" onClick={handleAdminLogin}>
                  Unlock →
                </button>
              </>
            ) : (
              <>
                ...
                <div className="form-field">
                  ...
                  <input
                    className="field-input"
                    placeholder="e.g. Day In The Life Vlog"
                    value={addForm.title}
                    onChange={(e) =>
                ...
                {addForm.category === 'YouTube / Long Format' && (
                  <div className="form-field">
                    ...
                    >
                      {YOUTUBE_SUBCATEGORIES.slice(1).map((s) => (
                ...
                <div className="form-field">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setAddForm({ ...addForm, youtubeUrl: e.target.value })
                    }
                  />
                </div>
                <div className="form-field">
                ...
                {addSuccess && (
                  <p className="field-success" style={{ marginBottom: '12px' }}>
                    ✓ Video added!
                  </p>
                )}
                <button className="btn-red" onClick={handleAddVideo}>
                  Add to Portfolio
                </button>
                    ...
                    <div key={v.id} className="video-row">
                      ...
                      <div className="video-row-info">
                        ...
                        <div className="video-row-tags">
                          ...
                          {v.subcategory && (
                            <span className="video-row-subcat">
                              {v.subcategory}
                            </span>
                          )}
                        </div>
